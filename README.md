Laboratório 544 - Kubernetes In Cloud: Orquestrando Microsserviços em Nuvem
=============================

Repositório para armazenar o Laboratório do curso Kubernetes In Cloud: Orquestrando Microsserviços em Nuvem da [4Linux][1]
...
---------- |:-----:|:-----------:|:-------------:|:---------------:
kube-client     | 1     | 1024MB | 172.16.0.201 | ubuntu-20.04-amd64
...
```bash
git clone https://github.com/4linux/544
cd 544/
vagrant up
```
